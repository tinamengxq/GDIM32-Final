...
public class Clerk : NPC
{
    ...
    [SerializeField]private DialogueNode catKnowledgeNode;
    ...
    private void OnQuestTrainingSelected()
    {
        ...
        switch (controller.CurrentTrainingStage)
        {
            case TrainingStage.NotStarted:
                ...
                //);
                DialogueManager.Instance.StartDialogue(trainingNotStartedNode, controller.AssignFeedQuest);
                break;
            ...
            case TrainingStage.FeedAssigned:
                //DialogueManager.Instance.StartLinearDialogue(
                  //  speakerName,
                    ...
                    //}
                //);
                DialogueManager.Instance.StartDialogue(trainingFeedAssignedNode);
                break;
            ...
            case TrainingStage.FeedCompleted:
               // DialogueManager.Instance.StartLinearDialogue(
                ...
                //);
                DialogueManager.Instance.StartDialogue(trainingFeedCompletedNode, controller.AssignPlayQuest);
                break;
               ...
               //     speakerName,
                 //   new[]
                   // {
                    ...
                    //}
                //);
                DialogueManager.Instance.StartDialogue(trainingPlayAssignedNode);
                break;
            ...
            case TrainingStage.PlayCompleted:
               // DialogueManager.Instance.StartLinearDialogue(
                ...
                //);
                DialogueManager.Instance.StartDialogue(trainingPlayCompletedNode, controller.MarkTrainingCompleted);
                break;
               ...
               // DialogueManager.Instance.StartLinearDialogue(
                 //   speakerName,
                   // new[]
                    ...
                    //}
                //);
                DialogueManager.Instance.StartDialogue(trainingCompletedNode);
                break;
        }
    }
       ...
       // DialogueManager.Instance.StartLinearDialogue(
         //   speakerName,
           // new[]
            ...
            //}
        //);
        DialogueManager.Instance.StartDialogue(catKnowledgeNode);
    }
}
